...
| Endpoint | `POST https://app-ctg0jdeaugap-api-qYGW2z745vzY-gateway.appmiaoda.com/caipiao/history` |
| Auth | `platform_managed`，`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| Content-Type | `application/json` |
| Third-party Domain | `app-ctg0jdeaugap-api-qYGW2z745vzY-gateway.appmiaoda.com` |
...
async function queryCaipiaoHistory(
  ...
  const url =
    `https://app-ctg0jdeaugap-api-qYGW2z745vzY-gateway.appmiaoda.com/caipiao/history?${params.toString()}`;
