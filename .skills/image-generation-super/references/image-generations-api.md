...
| Endpoint | `POST http://app-ctg0jdeaugap-api-wLNdpny6ZpVa-gateway.appmiaoda.com/v1/images/generations` |
...
async function createImage(params: CreateImageParams): Promise<CreateImageResult> {
  const response = await fetch(
    "http://app-ctg0jdeaugap-api-wLNdpny6ZpVa-gateway.appmiaoda.com/v1/images/generations",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
